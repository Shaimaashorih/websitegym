...
<body>
 ...
 @endif
     ...
     <form  action= "{{url('workouts' . '/' .$workouts->id )}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        @method('PATCH')      
                ...
                <div class="form-group row">
                    <label> Name </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="name" value="{{$workouts->name}}">
                            @error('name')
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="title" value="{{$workouts->title}}">
                            @error('title')
                                <div class="form-error">
                                    {{$message}}
                                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        <img src="{{asset('images/'.$workouts->image)}}">
                    </div>
                </div>
