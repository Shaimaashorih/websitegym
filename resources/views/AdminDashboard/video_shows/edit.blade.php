    ...
    <div class="flex-page d-flex row wrap">
     ...
     <div class="card-body">
        <div class="px-3">
            ...
            <form class="form form-horizontal" action= "{{url('video_shows/'. 1 )}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                @method("PUT")
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <div class="col-md-6 form-group">
                          <label>Title:</label>
                          <input type="text" name="title" class="form-control" value="{{$video_shows->title}}"/>
                       </div>
                       <div class="col-md-6 form-group">
                          <label>Select Video:</label>
                          <input type="file" name="path" class="form-control"/>
                          <video  autoplay muted style="width: 80%;">
                            <source src="{{asset('storage')}}/{{$video_shows['path']}}" type="video/mp4">
                          </video>
                       </div>
                       <div class="col-md-6 form-group">
