     ...
     <form  action= "{{url('articles/' . $articles->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="title_span" value="{{$articles->title_span}}" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea name="title_article"  rows="7" cols="50" >{{$articles->title_article}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="abotus_span" value="{{$articles->abotus_span}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label> Description </label>
                <div class="col-md-9">
                    <textarea name="abotus_article"  rows="7" cols="50" >{{$articles->abotus_article}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            <div>
                <h2>Courses Article</h2>
            </div>
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="courses_span" value="{{$articles->courses_span}}" >
                </div>
            </div>
            ...
            <div class="form-group row">
                <label> Description </label>
                <div class="col-md-9">
                    <textarea name="courses_article"  rows="7" cols="50">{{$articles->courses_article}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            <div>
                <h2>Trainer Article</h2>
            </div>
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="trainer_span" value="{{$articles->trainer_span}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label> Description </label>
                <div class="col-md-9">
                    <textarea name="trainer_article"  rows="7" cols="50">{{$articles->trainer_article}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="ourblog_span" value="{{$articles->ourblog_span}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label> Description </label>
                <div class="col-md-9">
                    <textarea name="ourblog_article"  rows="7" cols="50">{{$articles->ourblog_article}}"</textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            <div>
                <h2>Timetable Article</h2>
            </div>
            <div class="form-group row">
                <label> Title </label>
                <div class="col-md-9">
                    <input type="text"  class="form-control" name="timetable_span" value="{{$articles->timetable_span}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label> Description </label>
                <div class="col-md-9">
                    <textarea name="timetable_article"  rows="7" cols="50">{{$articles->timetable_article}}</textarea>
                </div>
            </div>
        </div>
