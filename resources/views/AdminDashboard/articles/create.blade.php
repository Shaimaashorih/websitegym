        ...
        {{csrf_field()}}
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="title_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <textarea name="title_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="abotus_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label> Description </label>
                    <div class="col-md-9">
                        <textarea name="abotus_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="courses_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label> Description </label>
                    <div class="col-md-9">
                        <textarea name="courses_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="trainer_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label> Description </label>
                    <div class="col-md-9">
                        <textarea name="trainer_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="ourblog_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label> Description </label>
                    <div class="col-md-9">
                        <textarea name="ourblog_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group row">
                    <label> Title </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="timetable_span" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label> Description </label>
                    <div class="col-md-9">
                        <textarea name="timetable_article"  rows="7" cols="50"></textarea>
                    </div>
                </div>
            </div>
