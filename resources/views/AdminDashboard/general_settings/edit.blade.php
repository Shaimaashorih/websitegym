                ...
                <div class="px-3">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form form-horizontal"
                            action="{{ url('general_settings/' . $general_settings->id) }}" method="POST"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="form-body">
                                <h4 class="form-section">
                                    <i class="icon-user"></i>general_settings
                                </h4>

                                <label class="col-md-3 label-control" for="projectinput1"> logo</label>
                                <div class="col-md-2">
                                    <input type="file" id="projectinput1" class="form-control" name="logo_path"
                                        value="{{ $general_settings->logo_path }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" id="projectinput1" class="form-control" name="phone2"
                                            value="{{ $general_settings->phone2 }}">
                                    </div>
                                    <label class="col-md-3 label-control" for="projectinput1"> email</label>
                                    <div class="col-md-2">
                                        <input type="text" id="projectinput1" class="form-control" name="email2"
                                            value="{{ $general_settings->email2 }}">
                                    </div>

                                    <label class="col-md-3 label-control" for="projectinput1"> facebook</label>
                                    <div class="col-md-2">
                                        <input type="text" id="projectinput1" class="form-control"
                                            name="facebook" value="{{ $general_settings->facebook }}">
                                    </div>

                                    <label class="col-md-3 label-control" for="projectinput1"> twitter</label>
                                    <div class="col-md-2">
                                        <input type="text" id="projectinput1" class="form-control" name="twitter"
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" id="projectinput1" class="form-control"
                                            name="instegram" value="{{ $general_settings->instegram }}">
                                    </div>
