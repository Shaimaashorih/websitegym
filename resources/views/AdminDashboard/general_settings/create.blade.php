...
<body>
    ...
    <div class="page-content padding-20">
        ...
        <div class="container d-flex row gap-20 wrap">
            ...
            {{-- ************************************ --}}
            <form action="{{ url('general_settings') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input type="link" id="projectinput1" class="form-control" name="facebook">
                        </div>

                        <label class="col-md-3 label-control" for="projectinput1"> name logo</label>
                        <div class="col-md-2">
