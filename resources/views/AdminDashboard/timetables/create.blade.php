...
<body>
    ...
    <div class="flex-page d-flex row wrap">
     ...
     <form  action= "{{url('timetables')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="form-group row">
          <label> DAY </label>
              <div style="width: 35%;">
                <select  name="day" class="form-control">
                  ...
                  <option value="SATRDAY"> SATRDAY </option>                                    
          ...
          <div class="table-responsive">
            ...
            <table class="table">
                 ...
                 <a class="btn btn-info " id="insertRow" >Add Timetable</a>
...
$("#insertRow").on("click", function (event) {
    ...
    cols += '';
    cols += '<td><div class="form-group row"><label>TIME</label><div class="col-md-9"><input type="time"  class="form-control" name="time[]" ><div class="form-control-position"><i class="ft-clock"></i></div></div></div></td>';
    cols += '<td><div class="form-group row"><label>workout traininig</label><select name="workout_id[]"  class="form-control"><option value="">choose workout </option>@foreach ($workouts as $key => $value)<option value="{{$value->id}}">{{$value->title}}</option>@endforeach</select></div></td>';
