...
<body>
    ...
    <div class="page-content padding-20">
        ...
        <div class="container d-flex row gap-20 wrap">
            ...
            <form action="{{ url('user_workouts/' . $user_workouts->id) }}" method="POST"
                    ...
                    <div style="width: 35%;">
                        ...
                        <select name="user_id" class="form-control">
                            @foreach ($users as $key => $value)
                                <option {{ $value->id == $user_workouts->user_id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select name="workout_id[]" class="form-control">
                                            ...
                                            @foreach ($workouts as $key => $value)
                                                <option {{ $value->id == $user_workouts->workout_id ? 'selected' : '' }}
    ...
    <script>
        $(function() {
            ...
            $("#insertRow").on("click", function(event) {
                ...
                cols +=
                    '<td><div class="form-group row"><div class="col-md-9"><input type="date"  class="form-control" name="date[]"  value="{{ $user_workouts->date }}"><div class="form-control-position"><i class="ft-clock"></i></div></div></div></td>';
                cols += `<td>          
                            <div class="form-group row">
                                <div class="col-md-9">
