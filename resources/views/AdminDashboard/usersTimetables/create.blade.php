    ...
    <script>
        $(function() {
            ...
            $("#insertRow").on("click", function(event) {
                ...
                cols += '';
                cols +=
                    '<td><div class="form-group row"><label>TIME</label><div class="col-md-9"><input type="time"  class="form-control" name="time[]" ><div class="form-control-position"><i class="ft-clock"></i></div></div></div></td>';
                cols +=
                    '<td><div class="form-group row"><label>workout traininig</label><select name="workout_id[]"  class="form-control"><option value="">choose workout </option>@foreach ($workouts as $key => $value)<option value="{{ $value->id }}">{{ $value->title }}</option>@endforeach</select></div></td>';
                cols +=
