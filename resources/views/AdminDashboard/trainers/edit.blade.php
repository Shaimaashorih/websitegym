...
<body>
 ...
 @endif
     ...
     <form  action= "{{url('trainers' . '/' .$trainers->id )}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        @method('PATCH')      
                ...
                <div class="form-group row">
                    <label> Job </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="job" value="{{$trainers->job}}">
                            @error('job')
                                <div class="form-error">
                                    {{$message}}
                                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="description" value="{{$trainers->description}}">
                            @error('description')
                                <div class="form-error">
                                    {{$message}}
                                </div>
                ...
                <div class="form-group row">
                    <label> Phone </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="phone" value="{{$trainers->phone}}">
                            @error('phone')
                                <div class="form-error">
                                    {{$message}}
                                </div>
                ...
                <div class="form-group row">
                    <label> Email </label>
                    <div class="col-md-9">
                        <input type="text"  class="form-control" name="email" value="{{$trainers->email}}">
                            @error('email')
                                <div class="form-error">
                                    {{$message}}
                                </div>
