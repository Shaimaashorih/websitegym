...
<body>
                ...
                <li data-dropDown class="">
                    ...
                    <div class="clospall">
                        <ul class="max-hieght">
                            ...
                            <li><a href="{{'/user_workouts'}}">Workout for workouts
                                </a></li>
   ...
   @endif
    ...
    <form  action= "{{url('coursesa' . '/' .$courses->id )}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        @method('PATCH')      
        ...
        <div class="form-group row">
            <label> Title </label>
            <div class="col-md-9">
                <input type="text"  class="form-control" name="title" value="{{$diet_menus->title}}">
                    @error('title')
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text"  class="form-control" name="description" value="{{$diet_menus->description}}">
                    @error('description')
                        <div class="form-error">
                            {{$message}}
                        </div>
        ...
        <div class="form-group row">
            <label> Name </label>
            <div class="col-md-9">
                <input type="text"  class="form-control" name="name" value="{{$diet_menus->name}}">
                    @error('name')
                        <div class="form-error">
                            {{$message}}
                        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <textarea name="ingridients" rows="4" cols="50">{{$diet_menus->ingridients}}</textarea>
                    @error('ingridients')
                        <div class="form-error">
                            {{$message}}
                        </div>
        ...
        <div class="form-group row">
            <label> times </label>
            <div class="col-md-9">
                <input type="text"  class="form-control" name="times" value="{{$diet_menus->times}}">
                    @error('times')
                        <div class="form-error">
                            {{$message}}
                        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                <img src="{{ asset('images/'.$diet_menus->image)}}">
            </div>
        </div>
