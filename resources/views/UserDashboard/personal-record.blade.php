    ...
    <div class="flex-page d-flex row wrap">
        ...
        <div class="page-content padding-20">
            ...
            <div class="container d-flex row gap-20 wrap">
                ...
                <div class="card b-white bx-shadow f-b33 running-table">
                    <!-- start container -->
                    <div class="card-container">
                        ...
                        <div class="top-title">
                            ...
                            <div>
                                <i class="fa-solid " data-color="rgb(255, 148, 50)"
                                    style="padding: 20px; width: 50px; height: 50px; background-color: #fff; 
                                    border-radius: 50%; display: flex; align-items: center; justify-content: center; ">
                                    <img src="{{URL::asset('images').'/'.$item->image}}"/>
                                </i>
                            </div>
                            <h4 class="c-white">{{$item->name}}</h4>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <th>
                                    <h3>{{$item->day}}</h3>
                                    <p class="c-font font-w500">{{$item->date}}</p>
                                    </th>
                                    <th>
                                        <h3>{{$item->distance}}KM</h3>
                                        <p class="c-font font-w500">Target {{round($item->distance , 0)}}Km</p>
                                    </th>
                                    <th>
                                        <h3>{{$item->duration}}</h3>
                                        <p class="c-font font-w500">Target {{$item->duration}}</p>
                                    </th>
                                </tr>
                             </tbody>
                        </table>
                ...
                @endforeach
                {{-- <!-- start card -->
                <div class="card b-white bx-shadow f-b33 cycling-table">
                    <!-- start container -->
                    <div class="card-container">
                        <!-- start top-title -->
                        <div class="top-title">
                            ...
                            <div>
                                <i class="fa-solid fa-person-biking f-b50 font-size24" data-color="rgb(46, 167, 195)"
                                    style="padding: 20px; width: 50px; height: 50px; background-color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; "></i>
                            </div>
                            <h4 class="c-white">Cycling</h4>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <th>
                                    <h3>Monday</h3>
                                    <p class="c-font font-w500">September 2, 2020</p>
                                </th>
                                <th>
                                    <h3>14.4KM</h3>
                                    <p class="c-font font-w500">Target 15Km</p>
                                </th>
                                <th>
                                    <h3>00:35:22</h3>
                                    <p class="c-font font-w500">Target 15min</p>
                                </th>
                            </tr>
                        </tbody>
                        </table>
                ...
                <!-- start card -->
                <div class="card b-white bx-shadow f-b33 yoga-tabel">
                    <!-- start container -->
                    <div class="card-container">
                        <!-- start top-title -->
                        <div class="top-title">
                            ...
                            <div>
                                <i class="fa-solid fa-child-reaching font-size24" data-color="rgb(188, 80, 203)"
                                    style="padding: 20px; width: 50px; height: 50px; background-color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; "></i>
                            </div>
                            <h4 class="c-white">Cycling</h4>
